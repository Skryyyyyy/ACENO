    ...
    <div className="flex flex-col items-center select-none">
      <div className="w-full flex justify-between items-center mb-3 px-2">
        <span className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
          <Activity className="w-4 h-4 text-white" /> iQOO Monochromatic Mobile
        </span>
        <span className="text-xs mono text-slate-500">Snapdragon NPU • 120Hz</span>
      </div>

      {/* Phone Mockup Frame */}
      <div className="phone-mockup relative flex flex-col overflow-hidden bg-[#090A0C]">
        
        {/* Dynamic Island Status Bar */}
        <div className="px-7 pt-3 pb-2 flex justify-between items-center text-xs font-semibold text-slate-400">
          <span className="mono">09:41</span>
          <div className="w-28 h-6 bg-black border border-white/10 rounded-full flex items-center justify-center space-x-1.5 px-3">
            <span className="h-1.5 w-1.5 rounded-full bg-white animate-pulse" />
            <span className="text-[9px] font-mono text-white tracking-widest">THUMP OS</span>
          </div>
        ...
        <div className="flex-1 flex flex-col px-6 py-3 justify-between overflow-y-auto">
            ...
            <div className="flex-1 flex flex-col justify-between space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-base font-black mono text-white tracking-widest">
                    THUMP
                  </span>
                  <button 
                    onClick={() => setActiveTab('NOTIFICATIONS')}
                    className="p-2 rounded-full bg-[#14171d] border border-white/10 text-white hover:bg-white/10 transition relative"
                  >
              ...
              <div className="bg-[#0e1014] border border-white/10 rounded-3xl p-5 shadow-2xl relative overflow-hidden">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-2">
                  YOUR CYLINDER
                </span>

                <div className="text-center my-2">
                  <span className="text-5xl font-black text-white mono tracking-tighter">
                ...
                {/* Progress Bar: ████████████░░░░ */}
                <div className="w-full bg-[#1c2027] h-3 rounded-full my-4 overflow-hidden border border-white/10 p-0.5">
                  <div 
                ...
                <div className="space-y-1 my-2 text-xs">
                  <div className="flex justify-between items-center text-slate-300 font-medium">
                    ...
                    <span className="mono text-white font-bold">~{daysLeft} days left</span>
                  </div>
                </div>

                {/* Reading Healthy */}
                <div className="pt-3 border-t border-white/10 flex items-center space-x-2 text-xs">
                  <span className="h-2 w-2 rounded-full bg-emerald-400 inline-block animate-pulse" />
                  <span className="text-white font-semibold text-[11px]">Reading healthy</span>
                </div>
              </div>

              {/* CARD 2: AI INSIGHT */}
              <div>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1.5 px-1">
                  AI INSIGHT
                </span>
                
                <div className="bg-[#14171d] border border-white/10 rounded-2xl p-4 flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="flex justify-between items-center mb-6">
                  <button
                    ...
                    className="p-2 -ml-2 rounded-full hover:bg-white/10 text-slate-400 hover:text-white transition flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    className="p-2 -mr-2 rounded-full hover:bg-white/10 text-slate-400 hover:text-white transition"
                    title="Mark all read"
                  >
                ...
                <div className="mb-5">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10">
                      <div className="flex items-center space-x-2 text-white text-xs font-bold mb-0.5">
                        <span className="text-amber-400">⚠️</span>
                        <span>Refill approaching</span>
                      </div>
                      <p className="text-xs text-slate-300">Cylinder 01 is at 18%.</p>
                    ...
                    <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10">
                      ...
                      <p className="text-xs text-slate-300">Cylinder 01 → 62%</p>
            ...
            <div className="flex-1 flex flex-col justify-between py-1">
              <div>
                ...
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-black text-white tracking-tight">Cylinders</h2>
                  <button
                    onClick={() => setActiveTab('ADD_CYLINDER')}
                    className="p-2 rounded-full bg-white text-black hover:bg-slate-200 transition"
                    title="Add Cylinder"
                  >
                    <Plus className="w-4 h-4" />
                  </button>
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-3 px-1">
                  2 CYLINDERS
                </span>

                <div className="space-y-3">
                  {/* Card 1: ⛽ Kitchen */}
                  <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 shadow-xl">
                    <div className="flex justify-between items-center mb-1">
                      <div className="flex items-center space-x-2">
                        <span className="text-base">⛽</span>
                        <span className="text-sm font-bold text-white">Kitchen</span>
                      </div>
                      <span className="text-sm font-black mono text-white">62%</span>
                    </div>

                    <div className="w-full bg-[#1c2027] h-2.5 rounded-full my-3 overflow-hidden border border-white/10 p-0.5">
                      <div className="bg-white h-full rounded-full" style={{ width: '62%' }} />
                    </div>

                    <div className="flex justify-between items-center text-xs text-slate-400 mt-2">
                      <span className="font-semibold text-slate-300">~8 days remaining</span>
                  ...
                  <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 shadow-xl">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-sm font-black mono text-white">18%</span>
                    </div>
              ...
              <button
                onClick={() => setActiveTab('ADD_CYLINDER')}
                className="w-full py-3.5 rounded-2xl bg-white/10 text-white font-bold text-xs hover:bg-white/20 transition border border-white/15 mt-4"
              >
            ...
            <div className="flex-1 flex flex-col justify-between py-1">
              <div>
                ...
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h2 className="text-base font-black text-white">Add Cylinder</h2>
                </div>
                ...
                <div 
                  ...
                  className="bg-[#0e1014] border-2 border-dashed border-white/20 hover:border-white rounded-3xl p-8 flex flex-col items-center justify-center cursor-pointer transition shadow-xl group my-4"
                >
                  <div className="h-16 w-16 rounded-3xl bg-[#14171d] border border-white/10 flex items-center justify-center text-white text-3xl mb-3 group-hover:scale-110 transition">
                    📷
                  </div>
                ...
                <div className="relative my-6 text-center">
                  ...
                  <span className="relative px-3 bg-[#090A0C] text-xs font-bold text-slate-500 uppercase tracking-widest">
                    OR
                  </span>
                </div>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-2xl bg-[#14171d] hover:bg-[#181B20] border border-white/15 text-white font-extrabold text-sm transition flex items-center justify-center gap-2 shadow-lg"
                >
            ...
            <div className="flex-1 flex flex-col justify-between py-1 relative">
              <div>
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <h2 className="text-base font-black text-white">Scan Cylinder</h2>
                  <div className="w-8" />
                </div>

                {/* Camera Viewfinder Box matching exact wireframe */}
                <div className="my-6 flex flex-col items-center justify-center">
                  <div className="w-60 h-64 border-2 border-white/30 rounded-3xl relative bg-black/40 flex flex-col items-center justify-center p-4 shadow-2xl backdrop-blur-sm">
                    {/* Corner Guides */}
            ...
            <div className="flex-1 flex flex-col justify-between py-1">
              <div>
                <div className="flex justify-between items-center mb-6">
                  <button
                    onClick={() => setActiveTab('SCAN_CAMERA')}
                    className="p-2 -ml-2 rounded-full hover:bg-white/10 text-slate-400 hover:text-white transition"
                  >
                    <ArrowLeft className="w-5 h-5" />
                  </button>
                  <h2 className="text-base font-black text-white">Detection Result</h2>
                  <div className="w-8" />
                </div>

                <div className="bg-[#0e1014] border border-white/10 rounded-3xl p-6 shadow-2xl space-y-4 my-4">
                  ...
                  <div className="space-y-2 text-xs border-t border-white/10 pt-4 font-mono">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-bold">ABC12345</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Type:</span>
                      <span className="text-white font-bold">Domestic LPG</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Capacity:</span>
                      <span className="text-white font-bold">14.2 kg</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1">
              <div>
                ...
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h2 className="text-base font-black text-white">Cylinder Details</h2>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#14171d] border border-white/10 rounded-2xl py-3.5 px-4 text-sm text-white focus:outline-none focus:border-white/30 transition font-medium"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#14171d] border border-white/10 rounded-2xl py-3.5 px-4 text-sm text-white focus:outline-none focus:border-white/30 transition font-mono font-bold"
                    />
                  </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <h2 className="text-base font-black text-white">Calibrate Cylinder</h2>
                  <div className="w-8" />
                </div>

                <span className="text-xs text-slate-400 block px-1 mb-4 font-mono">
                  Cylinder: <strong className="text-white">Kitchen</strong>
                </span>

                <div className="p-5 rounded-3xl bg-[#0e1014] border border-white/10 shadow-2xl space-y-4">
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Calibration improves accuracy for this specific cylinder.
                  </p>

                  <div className="space-y-2 pt-1">
                    <span className="text-xs font-bold text-white block">You'll record:</span>
                    <div className="space-y-1.5 pl-1">
                      <div className="flex items-center gap-2 text-xs text-slate-300 font-mono">
                        <span className="w-5 h-5 rounded-full bg-white/10 text-white flex items-center justify-center text-[11px] font-bold">1</span>
                        <span>Known FULL</span>
                      </div>
                      <div className="flex items-center gap-2 text-xs text-slate-300 font-mono">
                        <span className="w-5 h-5 rounded-full bg-white/10 text-white flex items-center justify-center text-[11px] font-bold">2</span>
                  ...
                  <div className="pt-2 border-t border-white/5 flex items-center justify-between text-xs text-slate-400">
                    ...
                    <span className="text-white font-mono font-bold">2 min</span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <h2 className="text-sm font-bold text-slate-300">Calibration</h2>
                  <span className="text-xs font-mono font-bold text-white px-2 py-0.5 rounded bg-white/10">1/2</span>
                </div>

                <div className="text-center my-2">
                  <h3 className="text-base font-black text-white tracking-wider">KNOWN FULL</h3>
                  <p className="text-xs text-slate-400 mt-0.5">Confirm the cylinder is known to be full.</p>
                </div>

                {/* Cylinder Graphic with Lower Shell highlight */}
                <div className="my-4 py-4 rounded-3xl bg-[#0e1014] border border-white/10 flex flex-col items-center justify-center relative overflow-hidden">
                  <div className="relative w-20 h-28 border-2 border-slate-600 rounded-t-2xl rounded-b-xl flex flex-col justify-end p-1">
                    ...
                    <div className="absolute bottom-3 -right-6 flex items-center gap-1">
                      <span className="text-[10px] text-white font-mono bg-white/20 px-1 rounded">TAP HERE</span>
                    </div>
                  </div>
                  <span className="text-xs text-slate-300 mt-4 font-medium">Position phone against the lower shell.</span>
                </div>

                {/* Status Checks */}
                <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 space-y-2 text-xs mb-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white font-bold font-mono flex items-center gap-1">
                      <Check className="w-3.5 h-3.5 text-white" /> OK
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-center">
                  <span className="text-xs text-slate-400 block font-medium">Tap 3 times</span>
                  <span className="text-sm text-white font-mono font-black">{calibFullTaps} / 3</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <h2 className="text-sm font-bold text-slate-300">Calibration</h2>
                  <span className="text-xs font-mono font-bold text-white px-2 py-0.5 rounded bg-white/10">2/2</span>
                </div>

                <div className="text-center my-2">
                  <h3 className="text-base font-black text-white tracking-wider">KNOWN EMPTY</h3>
                  <p className="text-xs text-slate-400 mt-0.5">Confirm the cylinder upper shell reference.</p>
                </div>
                ...
                <div className="my-4 py-4 rounded-3xl bg-[#0e1014] border border-white/10 flex flex-col items-center justify-center relative overflow-hidden">
                  ...
                  <span className="text-xs text-slate-300 mt-4 font-medium">Position phone against the upper shell.</span>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-center">
                  <span className="text-xs text-slate-400 block font-medium">Tap 3 times</span>
                  <span className="text-sm text-white font-mono font-black">{calibEmptyTaps} / 3</span>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'CALIBRATION_SUCCESS' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <h2 className="text-base font-black text-white">Calibration Complete ✓</h2>
                  <div className="w-4" />
                </div>
                ...
                <div className="p-5 rounded-3xl bg-[#0e1014] border border-white/10 shadow-2xl space-y-4">
                  ...
                  <div className="space-y-2 pb-2 border-b border-white/5">
                    <div className="flex justify-between items-center text-xs">
                      <span className="text-slate-300 font-medium">FULL signature</span>
                      <span className="text-white font-bold font-mono">✓</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="text-slate-300 font-medium">EMPTY signature</span>
                      <span className="text-white font-bold font-mono">✓</span>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center text-xs mb-1.5">
                      ...
                      <span className="text-white font-bold font-mono">91%</span>
                    </div>
                  ...
                  {/* Ready text */}
                  <div className="pt-2">
                    <p className="text-xs text-white font-bold">Your cylinder is ready.</p>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <h2 className="text-base font-black text-white">Measure</h2>
                  <div className="w-8" />
                </div>

                <span className="text-xs text-slate-400 block px-1 mb-4 font-medium">
                  Select cylinder
                </span>
                ...
                <div className="space-y-3">
                  ...
                  <div
                    ...
                    className={`p-4 rounded-2xl border cursor-pointer transition ${
                      selectedCylinderForMeasure === 'Kitchen'
                        ? 'bg-[#181c24] border-white text-white shadow-lg'
                        : 'bg-[#14171d] border-white/10 text-slate-400 hover:border-white/30'
                    }`}
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="text-sm font-black text-white block">Kitchen</span>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="text-sm font-black text-white block">Backup</span>
                        <span className="text-xs text-slate-400 font-mono mt-0.5 block">
                          18% • calibrated ✓
                        </span>
                      </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-1">
                  ...
                  <h2 className="text-sm font-black text-white tracking-widest uppercase">THUMP</h2>
                  <div className="w-8" />
                </div>
                ...
                <div className="text-center my-1.5">
                  ...
                  <h3 className="text-base font-black text-white tracking-wide">POSITION PHONE</h3>
                </div>

                {/* ASCII / Monochromatic Phone-on-Cylinder Visual */}
                <div className="my-3 py-4 rounded-3xl bg-[#0e1014] border border-white/10 flex flex-col items-center justify-center relative">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="w-7 h-11 border-2 border-white rounded-md flex flex-col items-center justify-between p-0.5 bg-black shadow-lg">
                      ...
                      <span className="text-[6px] font-mono text-white font-bold">📱</span>
                    ...
                    {/* Cylinder Frame */}
                    <div className="w-20 h-24 border-2 border-slate-500 rounded-t-2xl rounded-b-xl flex flex-col items-center justify-center p-1 bg-black/40 relative">
                  ...
                  <span className="text-xs text-slate-300 mt-3 font-medium">Place against the cylinder.</span>
                </div>

                {/* Sensor Indicators */}
                <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 space-y-2 text-xs">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Contact</span>
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-white text-black font-extrabold text-sm hover:bg-slate-200 active:scale-98 transition flex items-center justify-center gap-2 shadow-xl shadow-white/5 mt-3"
              >
                <span>READY</span>
              </button>
            </div>
              ...
              <div>
                ...
                <div className="flex justify-between items-center mb-1">
                  ...
                  <button
                    ...
                    className="text-[10px] font-mono text-slate-500 hover:text-amber-400 underline"
                ...
                <div className="text-center my-1.5">
                  ...
                  <h3 className="text-base font-black text-white tracking-wide">TAP NOW</h3>
                </div>

                {/* Strike Target Indicator ◉ */}
                <div className="my-2 py-4 rounded-3xl bg-[#0e1014] border border-white/10 flex flex-col items-center justify-center relative">
                  ...
                  <button
                    ...
                    className={`px-10 py-3.5 rounded-2xl border-2 font-black text-base transition duration-150 active:scale-95 shadow-2xl flex items-center justify-center gap-2 ${
                      tapHapticFlash
                        ? 'bg-emerald-400 border-emerald-400 text-black shadow-emerald-400/40 scale-105'
                  ...
                  <div className="mt-3">
                    <span className="text-base font-black text-white font-mono">{measureTaps} / 5</span>
                  </div>
                </div>

                {/* LIVE SENSOR HUD (iQOO Hackathon Hardware & Sensor Telemetry) */}
                <div className="p-3.5 rounded-2xl bg-[#0e1014] border border-white/10 space-y-2 text-xs font-mono">
                  <div className="flex justify-between items-center text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-1 border-b border-white/5">
                    <span>LIVE SENSOR HUD</span>
                    <span className="text-emerald-400 font-bold">48kHz • 200Hz IMU</span>
                  </div>
                ...
                <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 space-y-2">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-400">Tap strength</span>
                    <span className="text-white font-mono font-bold">{tapStrength}%</span>
                  </div>
          ...
          {activeTab === 'MEASURE_BAD_TAP' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
                <div className="w-16 h-16 rounded-3xl bg-[#1c1414] border border-amber-500/30 flex items-center justify-center mb-4 text-3xl shadow-xl">
                  ⚠️
                </div>

                <h2 className="text-base font-black text-white tracking-wide mb-2 uppercase">
                  TAP NOT USABLE
                </h2>

                <p className="text-xs text-slate-300 leading-relaxed max-w-xs mb-3">
          ...
          {activeTab === 'MEASURE_ANALYSIS' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <h2 className="text-base font-black text-white tracking-widest uppercase">ANALYZING</h2>
                  <span className="text-xs font-mono font-bold text-white px-2 py-0.5 rounded bg-white/10">THUMP</span>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-[#0e1014] border border-white/10 mb-4 flex flex-col items-center justify-center">
                  <svg className="w-full h-12 stroke-white fill-none" viewBox="0 0 200 40">
                    <path
                  ...
                  {[
                    ...
                    <div key={item.step} className="flex items-center space-x-2">
                      <span className={`font-mono font-bold ${
                        analysisStep >= item.step ? 'text-white' : 'text-slate-600'
                      }`}>
                        ✓
                      </span>
                ...
                {/* Confidence Bar */}
                <div className="mt-4 p-3 rounded-2xl bg-[#14171d] border border-white/10">
                  <div className="flex justify-between items-center text-xs mb-1.5">
                    <span className="text-slate-400">Confidence</span>
                    <span className="text-white font-mono font-bold">87%</span>
                  </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <h2 className="text-sm font-bold text-white">Measurement Result</h2>
                  <button
                ...
                <div className="text-center my-1">
                  <span className="text-xs font-black text-white uppercase tracking-widest block font-mono">
                    {selectedCylinderForMeasure.toUpperCase()}
                  </span>
                </div>

                {/* Hero Readout Card */}
                <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 shadow-2xl flex flex-col items-center text-center space-y-2.5 my-2">
                  ...
                  {/* Monochromatic Bar ████████████░░░░ */}
                  <div className="w-full bg-slate-800 rounded-full h-2.5 overflow-hidden border border-white/10 my-1">
                    <div className="bg-white h-full rounded-full" style={{ width: '62%' }} />
                  </div>
                ...
                <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 space-y-2 text-xs">
                  ...
                  <div className="pt-2 border-t border-white/10 flex justify-between items-center">
                    <span className="text-emerald-400 font-bold font-mono">✓ Confidence: 91%</span>
                    <span className="text-slate-400 font-mono">±6% estimated level</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 mt-2">
                <button
                  onClick={() => setActiveTab('HOME')}
                  className="w-full py-3.5 rounded-2xl bg-white text-black font-extrabold text-sm hover:bg-slate-200 active:scale-98 transition flex items-center justify-center gap-2 shadow-xl shadow-white/5"
                >
                ...
                <div className="flex items-center justify-between px-2">
                  <button
                    ...
                    className="text-xs text-slate-400 hover:text-white transition font-medium py-1"
                  >
                    Measure Again
                  </button>
                  ...
                  <button
                    onClick={() => setActiveTab('ACOUSTIC_ANALYSIS')}
                    className="text-xs text-slate-300 hover:text-white transition font-bold py-1 flex items-center gap-1"
                  >
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <h2 className="text-sm font-black text-white tracking-tight">Acoustic Analysis</h2>
                  <div className="w-8" />
                </div>

                <div className="space-y-3 overflow-y-auto max-h-[460px] pr-1">
                  {/* Card 1: RAW RESPONSE */}
                  <div className="p-3.5 rounded-2xl bg-[#0e1014] border border-white/10">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">
                      RAW RESPONSE
                    </span>
                    <div className="py-2 flex items-center justify-center">
                      <svg className="w-full h-10 stroke-white fill-none" viewBox="0 0 200 35">
                        <path
                  ...
                  {/* Card 2: SPECTRUM */}
                  <div className="p-3.5 rounded-2xl bg-[#0e1014] border border-white/10 space-y-2.5">
                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1.5">
                        SPECTRUM
                      </span>
                      <div className="flex items-end space-x-1.5 h-8 px-2 bg-black/40 rounded-lg py-1 border border-white/5">
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-1 border-t border-white/5">
                      <div>
                        ...
                        <span className="text-xs font-mono font-bold text-white">2.84 kHz</span>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 block">Decay rate</span>
                        <span className="text-xs font-mono font-bold text-white">0.71</span>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 block">RMS energy</span>
                        <span className="text-xs font-mono font-bold text-white">0.183</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 space-y-2 text-xs">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400 font-mono">DSP Classification</span>
                      <span className="text-white font-bold font-mono px-2 py-0.5 rounded bg-white/10">GAS-LIKE</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400 font-mono">ML (TFLite NPU)</span>
                      <span className="text-white font-bold font-mono px-2 py-0.5 rounded bg-white/10">GAS-LIKE</span>
                    </div>
                  ...
                  <div className="pt-2 text-center">
                    <span className="text-[10px] font-mono text-slate-400">
                      Model: <strong className="text-white">THUMP-Lite v1</strong>
                    </span>
                  </div>
                </div>
                </div>
              ...
              <button
                onClick={() => setActiveTab('MEASURE_RESULT')}
                className="w-full py-3.5 rounded-2xl bg-white text-black font-extrabold text-sm hover:bg-slate-200 active:scale-98 transition flex items-center justify-center gap-2 shadow-xl shadow-white/5 mt-3"
              >
          ...
          {activeTab === 'HISTORY' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <span className="text-xs font-mono font-black text-white tracking-widest block uppercase mb-2">
                  KITCHEN
                </span>

                {/* Monochromatic Trend Line Graph */}
                <div className="p-3.5 rounded-2xl bg-[#0e1014] border border-white/10 mb-3">
                  <div className="flex justify-between items-center text-xs font-mono text-slate-400 mb-2">
                    <span className="text-white font-bold">62% Current</span>
                    <span>30-Day Trend</span>
                  </div>

                  <div className="relative h-20 w-full flex items-center justify-center">
                    <svg className="w-full h-full stroke-white fill-none" viewBox="0 0 240 70">
                      {/* Grid lines */}
                      ...
                      {/* Spark Points */}
                      <circle cx="10" cy="15" r="3.5" fill="#FFFFFF" />
                      <circle cx="60" cy="22" r="3" fill="#FFFFFF" />
                      <circle cx="120" cy="38" r="3" fill="#FFFFFF" />
                      <circle cx="180" cy="48" r="3" fill="#FFFFFF" />
                ...
                <div className="space-y-1.5 mb-3">
                  {[
                    ...
                    <div key={i} className="px-3 py-2 rounded-xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs font-mono">
                ...
                {/* Consumption Box */}
                <div className="p-3.5 rounded-2xl bg-[#0e1014] border border-white/10 space-y-1">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block">
                    Consumption
                  </span>
                  <div className="flex justify-between items-center text-xs font-mono">
                    <span className="text-slate-300">Avg: 0.76 kg/day</span>
          ...
          {activeTab === 'AI' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                {/* Header: AI Insights */}
                <div className="flex justify-between items-center mb-1">
                  <h2 className="text-base font-black text-white">AI Insights</h2>
                  <div className="w-4" />
                </div>
                ...
                <div className="space-y-3 overflow-y-auto max-h-[460px] pr-1">
                  ...
                  <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 space-y-2">
                    ...
                    <div className="text-xs text-slate-400 font-mono">
                      Expected empty: <strong className="text-white">Sep 16</strong>
                    </div>
                  </div>

                  {/* Card 2: 📉 USAGE TREND */}
                  <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 space-y-1.5">
                    <div className="flex items-center space-x-2 text-xs font-black text-white">
                      <span>📉</span>
                      <span className="tracking-wider uppercase">USAGE TREND</span>
                    </div>
                    <p className="text-xs text-slate-300 leading-relaxed">
                      Consumption is <strong className="text-white font-bold">12% lower</strong> than your 30-day avg.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 space-y-1.5">
                    <div className="flex items-center space-x-2 text-xs font-black text-amber-400">
                      <span>⚠️</span>
                      <span className="tracking-wider uppercase text-white">ANOMALY</span>
                    </div>
                    <p className="text-xs text-slate-300 leading-relaxed">
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <h2 className="text-base font-black text-white">Ask THUMP</h2>
                  <div className="w-8" />
                </div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <button
                      ...
                      className={`text-xs px-2.5 py-1 rounded-full border transition ${
                        voiceQuery === 'refill' ? 'bg-white text-black font-bold border-white' : 'bg-[#14171d] text-slate-400 border-white/10'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`text-xs px-2.5 py-1 rounded-full border transition ${
                        voiceQuery === 'level' ? 'bg-white text-black font-bold border-white' : 'bg-[#14171d] text-slate-400 border-white/10'
                      }`}
                    >
                      "How much gas?"
                    </button>
                ...
                <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 space-y-2">
                  <div className="flex items-center space-x-2 text-[10px] font-mono text-emerald-400 font-bold uppercase tracking-wider">
                    <span>🔊</span>
                    <span>THUMP Voice Assistant</span>
                  </div>
                  {voiceQuery === 'refill' ? (
                    <p className="text-xs text-white leading-relaxed font-sans">
                      "Based on your recent consumption, your cylinder is estimated to run out around <strong className="text-white font-bold underline decoration-white/40">September 16</strong>. I'd recommend arranging a refill before then."
                    </p>
                  ) : (
                    <p className="text-xs text-white leading-relaxed font-sans">
                      "You have approximately <strong className="text-white font-mono font-bold">62%</strong> gas remaining (~6.2 kg). Based on your recent usage, that's about <strong className="text-white font-mono font-bold">8 days</strong>."
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center my-2">
                <button
                  ...
                  className={`w-14 h-14 rounded-full flex items-center justify-center transition active:scale-95 shadow-2xl ${
                    isListening ? 'bg-emerald-400 text-black scale-110 shadow-emerald-400/40' : 'bg-white text-black hover:bg-slate-200'
                  }`}
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <h2 className="text-base font-black text-white">Consumption</h2>
                  <div className="w-8" />
                </div>
                ...
                <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 text-center mb-3">
                ...
                {/* Step / Curve Chart */}
                <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 mb-3">
                  <div className="relative h-24 w-full flex items-center justify-center">
                    <svg className="w-full h-full stroke-white fill-none" viewBox="0 0 240 80">
                      <path
                      ...
                      <circle cx="230" cy="70" r="3" fill="#FFFFFF" />
                    </svg>
                  </div>
                  <div className="flex justify-between text-[9px] font-mono text-slate-500 pt-1 border-t border-white/5">
                    <span>Week 1</span>
                ...
                <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 space-y-2 text-xs font-mono">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Average</span>
                    <span className="text-white font-bold">0.76 kg/day</span>
                  </div>
                  <div className="flex justify-between items-center pt-1 border-t border-white/5">
                    <span className="text-slate-400">Compared to previous month</span>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <div className="flex items-center space-x-1.5 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-bold font-mono">
                    <span>🟠</span>
                    <span>OFFLINE</span>
                  </div>
                  <div className="w-6" />
                ...
                <div className="p-5 rounded-3xl bg-[#0e1014] border border-white/10 shadow-2xl space-y-4 mb-3">
                  <div>
                    <h3 className="text-sm font-black text-white">Your readings still work.</h3>
                ...
                <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 text-center">
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <h2 className="text-base font-black text-white">Sync Status</h2>
                  <button
                    onClick={() => {
                      setIsOffline(true);
                      setActiveTab('OFFLINE_MODE');
                    }}
                    className="text-[10px] font-mono text-slate-500 hover:text-amber-400"
                ...
                <div className="my-4 p-6 rounded-3xl bg-[#0e1014] border border-white/10 shadow-2xl flex flex-col items-center text-center space-y-3">
                  ...
                  <div>
                    <h3 className="text-lg font-black text-white tracking-wider">SYNCED</h3>
                  ...
                  {/* Sync Metrics Table */}
                  <div className="w-full p-3.5 rounded-2xl bg-[#14171d] border border-white/5 text-left space-y-2 text-xs font-mono">
                    <div>
                      <span className="text-[10px] text-slate-400 uppercase tracking-widest block">Last sync</span>
                      <span className="text-white font-bold">Today, 2:42 PM</span>
                    </div>

                    <div className="pt-1.5 border-t border-white/5">
                      <span className="text-[10px] text-slate-400 uppercase tracking-widest block">Measurements</span>
                      <span className="text-white font-bold block">28 synced</span>
                    ...
                    <div className="pt-1.5 border-t border-white/5 flex justify-between items-center">
                      <span className="text-[10px] text-slate-400 uppercase tracking-widest">Cylinder data</span>
                      <span className="text-emerald-400 font-bold">✓ Up to date</span>
                    </div>

                    <div className="pt-1.5 border-t border-white/5 flex justify-between items-center">
                      <span className="text-[10px] text-slate-400 uppercase tracking-widest">AI insights</span>
                      <span className="text-emerald-400 font-bold">✓ Up to date</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div className="overflow-y-auto max-h-[500px] pr-1 space-y-3">
                ...
                <div className="flex flex-col items-center justify-center py-2 text-center">
                  <div className="w-16 h-16 rounded-full bg-[#14171d] border-2 border-white/20 flex items-center justify-center mb-2 shadow-xl">
                    <User className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-base font-black text-white">Bala Murugan</h3>
                  <span className="text-xs text-slate-400 font-mono mt-0.5">bala@email.com</span>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div
                    ...
                    className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white hover:border-white/20 transition cursor-pointer"
                  >
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div className="overflow-y-auto max-h-[500px] pr-1 space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white">
                      <span>Gas unit</span>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white">
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg font-mono text-[10px] font-bold transition ${
                          notifLowGas ? 'bg-white text-black' : 'bg-white/10 text-slate-400'
                        }`}
                      >
                        {notifLowGas ? '[ ON ]' : '[ OFF ]'}
                      </button>
                    ...
                    <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white">
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg font-mono text-[10px] font-bold transition ${
                          notifRefillPrediction ? 'bg-white text-black' : 'bg-white/10 text-slate-400'
                        }`}
                      >
                    ...
                    <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white">
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg font-mono text-[10px] font-bold transition ${
                          notifAnomaly ? 'bg-white text-black' : 'bg-white/10 text-slate-400'
                        }`}
                      >
                        {notifAnomaly ? '[ ON ]' : '[ OFF ]'}
                      </button>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white">
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg font-mono text-[10px] font-bold transition ${
                          notifSyncComplete ? 'bg-white text-black' : 'bg-white/10 text-slate-400'
                        }`}
                      >
                    ...
                    <div className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white">
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg font-mono text-[10px] font-bold transition ${
                          notifWeeklySummary ? 'bg-white text-black' : 'bg-white/10 text-slate-400'
                        }`}
                      >
                    ...
                    <div
                      ...
                      className="p-3 rounded-2xl bg-[#14171d] border border-white/5 flex justify-between items-center text-xs text-white cursor-pointer hover:border-white/20 transition"
                    >
          ...
          {activeTab === 'PRIVACY_SETTINGS' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div className="overflow-y-auto max-h-[500px] pr-1 space-y-4">
                ...
                {/* YOUR DATA */}
                <div className="space-y-1.5">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block px-1 font-mono">
                    YOUR DATA
                  </span>

                  <div className="p-4 rounded-3xl bg-[#0e1014] border border-white/10 space-y-3 text-xs">
                    <div>
                      <span className="text-white font-bold block">Acoustic recordings</span>
                    ...
                    <div className="pt-2 border-t border-white/5">
                      <span className="text-white font-bold block">Camera</span>
                    ...
                    <div className="pt-2 border-t border-white/5">
                      <span className="text-white font-bold block">AI processing</span>
                      <span className="text-slate-300 text-[11px] block mt-0.5">
                    ...
                    <div className="pt-2 border-t border-white/5">
                      <span className="text-white font-bold block">Cloud sync</span>
                      <span className="text-slate-300 text-[11px] block mt-0.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/10 space-y-2 text-xs font-mono">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Microphone (48kHz)</span>
                      <span className="text-white font-bold">Active on Tap</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Accelerometer / Gyro</span>
                      <span className="text-white font-bold">200Hz Sampled</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Snapdragon NPU</span>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div className="overflow-y-auto max-h-[500px] pr-1 space-y-3">
                ...
                <div className="flex justify-between items-center mb-1">
                  ...
                  <h2 className="text-base font-black text-white">How to Measure</h2>
                  <div className="w-8" />
                </div>
                ...
                <div className="space-y-2.5">
                  ...
                  {/* Tips Card */}
                  <div className="p-3.5 rounded-2xl bg-[#14171d] border border-white/5 space-y-1.5 text-xs">
          ...
          {activeTab === 'MEASURE_ERROR' && (
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
                ...
                <h2 className="text-base font-black text-white tracking-wide mb-1">
                  Measurement unclear
                </h2>
                ...
                <div className="w-full p-4 rounded-3xl bg-[#0e1014] border border-white/10 text-left space-y-2 text-xs">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block font-mono">
                    Possible causes:
                  </span>
              ...
              <div className="space-y-2 mt-4">
                ...
                <button
                  ...
                  className="w-full py-2 text-xs text-slate-400 hover:text-white transition font-medium text-center"
                >
                  Troubleshoot
                </button>
              </div>
            ...
            <div className="flex-1 flex flex-col justify-between py-1 animate-in fade-in duration-200">
              <div>
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <h2 className="text-base font-black text-white">About THUMP</h2>
                  <div className="w-8" />
                </div>

                <div className="p-6 rounded-3xl bg-[#0e1014] border border-white/10 shadow-2xl space-y-4 mb-3">
                  <div className="flex items-center space-x-3 pb-3 border-b border-white/10">
                    <div className="w-12 h-12 rounded-2xl bg-white text-black flex items-center justify-center font-black text-xl tracking-tight shadow-xl">
                      T
                    </div>
                    <div>
                      <h3 className="text-base font-black text-white tracking-wider">THUMP</h3>
                      <p className="text-xs text-slate-400">Measure what's inside.</p>
                    </div>
                  </div>
              ...
              <button
                onClick={() => setActiveTab('HOME')}
                className="w-full py-4 rounded-2xl bg-white text-black font-extrabold text-sm hover:bg-slate-200 active:scale-98 transition flex items-center justify-center gap-2 shadow-xl shadow-white/5 mt-2"
              >
          ...
          {/* ========================================================= */}
          <div className="relative mt-2 pt-2 border-t border-white/10 flex justify-between items-center px-1">
            {/* Left Tab 1: Home */}
            <button
              onClick={() => setActiveTab('HOME')}
              ...
              <button
                ...
                className={`w-12 h-12 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 active:scale-95 border-2 ${
                  ['MEASURE_SELECT', 'MEASURE_POSITION', 'MEASURE_TAP', 'MEASURE_BAD_TAP', 'MEASURE_ANALYSIS'].includes(activeTab)
                    ...
                    : 'bg-white text-black border-white/80 hover:bg-slate-200 hover:scale-105'
                }`}
                title="Start Measurement"
              >
                <Plus className="w-6 h-6 stroke-[2.5]" />
              </button>
              <span className="text-[8px] font-black tracking-widest text-white uppercase mt-0.5 font-mono">
                MEASURE
              </span>
            </div>
